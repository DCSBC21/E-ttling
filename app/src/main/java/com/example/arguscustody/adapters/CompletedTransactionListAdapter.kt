...
class CompletedTransactionListAdapter(
	private val context: Context,
	private val onClick: () -> Unit
): RecyclerView.Adapter<CompletedTransactionListAdapter.ViewHolder>() {
	private val txs : ArrayList<Tx> = Stash.getArrayList("TX_LIST", Tx::class.java)

	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
		val view = LayoutInflater.from(parent.context).inflate(R.layout.item_completed_transaction, parent, false)
